...
export default function DefaultNavBar({ cartToggle, searchToggle, signInToggle, wishListToggle, navLink, isDesktop, categories, isScrolled, logo, token, cart, wishlist }) {
