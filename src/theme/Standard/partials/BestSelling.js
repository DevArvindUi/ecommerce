...
const BestSelling = () => {
   ...
   return (
      <div className="container-fluid position-relative greyBg section-gap">
         <div className="row mb-5">
            <div className="col-6">
               <h2 className="text-center fontMb18">Best Selling</h2>
            </div>
         </div>
            ...
            <div className="col-12 mt-4">
               <Carousel
                  ...
                  {products?.map((product, index) => (
                     <div key={index} className="position-relative product-card">
