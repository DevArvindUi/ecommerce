...
export default function StandardNavBar({ cartToggle, searchToggle, signInToggle, wishListToggle, navLink, isDesktop, categories, isScrolled, logo, token, cart, wishlist }) {
